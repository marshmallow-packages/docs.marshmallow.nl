...
const styles = {
  note: {
    ...
    body: 'text-red-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:text-red-900 prose-code:text-red-900 dark:text-slate-300 dark:prose-code:text-slate-300',
  },
  warning: {
    container:
